...
- Al acercarse un usuario con la app abierta a un slot ocupado con una bicicleta, la misma se comunica para asignarle la bicicleta y liberarla, pre-autorizando un monto
de seguridad en su tarjeta de crédito. (Simular mediante una conexión socket)
